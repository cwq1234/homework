...
CREATE LOGIN chenweiquan
WITH PASSWORD='chenweiquan',
...
CREATE USER [usr1] FOR LOGIN [chenweiquan]
CREATE USER [usr2] FOR LOGIN [chenweiquan]
CREATE USER [usr3] FOR LOGIN [chenweiquan]
GO 
